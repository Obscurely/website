      ...
      <main className="border-slate-730 bg-slate-850 relative mx-auto max-w-2xl rounded-2xl border p-8 shadow-xl">
        ...
        <div className="flex flex-col justify-center gap-4 sm:flex-row">
          ...
          <Link href="/" passHref>
            <Button
              variant="outline"
              className="border-cyan-560 hover:border-cyan-590 h-10 w-full cursor-pointer rounded-lg px-4 py-3 text-slate-300 transition-all duration-300 hover:text-white hover:shadow-lg hover:shadow-cyan-500/10"
            >
