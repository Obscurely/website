...
export const Footer = ({ isBlog = false, isMain = false }: FooterProps) => {
  ...
  const { useAnchorLinks, footerSections } = useFooter(isBlog, isMain);
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-14 lg:gap-8">
          ...
          <div className="lg:col-span-5">
            {isBlog || useAnchorLinks ? (
              ...
              >
                <span className="bg-blue-400 bg-clip-text text-2xl font-bold text-transparent transition-all duration-300">
                  {SITE_CONFIG.name}
                </span>
              </Link>
            ) : (
