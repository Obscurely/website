...
export const AboutJourney = () => {
  return (
    <div
      className="border-slate-730 data-[state=once]:animate-in fade-in slide-in-from-left-25 rounded-xl border bg-slate-800/20 p-6 opacity-0 duration-500 ease-out data-[state=once]:opacity-100"
      data-state="once"
    >
