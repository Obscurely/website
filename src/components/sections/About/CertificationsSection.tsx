...
const CertificationCard = memo(function CertificationCard({
  ...
  return (
    <a
      ...
      className="group flex flex-col rounded-lg border border-slate-700/30 bg-slate-800/40 p-4 transition-all duration-300 hover:border-cyan-500/30 hover:bg-slate-800/60 hover:shadow-lg hover:shadow-cyan-500/5"
    >
